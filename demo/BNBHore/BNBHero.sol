    ...
    IERC721ReceiverUpgradeable
{
    ...
    using EnumnerableSet for EnumerableSet.UintSet;
    IRandoms public randoms;
    IBNBCharacter public characters;
    ...
    event CreatedAndSendPrizeHero(address account, uint256 heroId);
        ...
        returns (uint256)
    {
        ...
        require(
            bnbhToken.bannedList(player) >= characterPrice,
    ...
    function createNewHero() public {
        require(
            bannedList[msg.sender] == flase && isContract(msg.sender) == false
        );
    ...
    function tokenHeroFromBag(uint256 heroId) public {
        require(
            heroIDsInBag[msg.sender].containes(heroId) == true,
        ...
        emit tokenHeroFromBag(msg.sender, heroId);
    }
    ...
    function fight(uint256 _attractingHero, uint256 enemyType) public {
        require(
